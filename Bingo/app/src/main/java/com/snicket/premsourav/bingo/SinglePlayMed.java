...
public class SinglePlayMed extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ib2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(SinglePlayMed.this, "FILL ALL THE BOXES!!!", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    if(player.isPlaying())
                    ...
                    Intent i = new Intent(SinglePlayMed.this, PlayGameMed.class);
                    i.putExtra("n1",s1);
                    i.putExtra("n2",s2);
                    i.putExtra("n3",s3);
                    i.putExtra("n4",s4);
    ...
    public void onBackPressed() {
        final Dialog d= new Dialog(SinglePlayMed.this);
        d.setTitle("Return?");
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i=new Intent(SinglePlayMed.this,MainActivity.class);
                startActivity(i);
                finish();
            }
        });
