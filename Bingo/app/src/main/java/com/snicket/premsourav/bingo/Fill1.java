...
public class Fill1 extends AppCompatActivity{
    ...
    public void onBackPressed() {
        final Dialog d= new Dialog(Fill1.this);
        d.setTitle("Return?");
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i=new Intent(Fill1.this,MainActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    void playerOne()
    {
        ...
        else
        {
            ...
            String v1="insert into fillone values('"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"','"+s6+"','"+s7+"','"+s8+"','"+s9+"','"+s10+"','"+s11+"','"+s12+"','"+s13+"','"+s14+"','"+s15+"','"+s16+"','"+s17+"','"+s18+"','"+s19+"','"+s20+"','"+s21+"','"+s22+"','"+s23+"','"+s24+"','"+s25+"')";
            db.execSQL(v1);
            db.close();
            Intent i = new Intent(Fill1.this, BackDialog2.class);
            startActivity(i);
            finish();
        }
    }
